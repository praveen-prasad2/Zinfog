...
function Login() {
  return (
    <div
      div
      className="w-screen h-auto loginBg flex flex-col justify-center items-center py-10"
    >
      <div className="w-[500px] h-[650px] bg-white rounded-[50px]">
        ...
        {/* <img src="/Images/Vector2.svg" alt="" className="pr-10" /> */}
      ...
      <div className=" w-screen text-white flex flex-row justify-around pt-5 poppins-semibold text-[12px]">
        ...
        <h1>All Rights Reserved  | <span className="text-[#1f6acb] cursor-pointer">Terms and Conditions</span> | <span className="text-[#1f6acb] cursor-pointer">Privacy Policy</span></h1>
      </div>
    </div>
  );
}
